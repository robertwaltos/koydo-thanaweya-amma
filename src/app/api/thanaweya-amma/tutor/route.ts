...
const EXAM_ID = "thanaweya-amma";
const EXAM_DISPLAY_NAME = "الثانوية العامة (Thanaweya Amma — Egyptian General Secondary Certificate)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. يرجى الإجابة دائمًا باللغة العربية.

يغطي جميع مواد الثانوية العامة المصرية: اللغة العربية، التاريخ، الجغرافيا، الفلسفة، الرياضيات، الفيزياء، الكيمياء، الأحياء. يتوافق مع مناهج وزارة التربية والتعليم المصرية.
