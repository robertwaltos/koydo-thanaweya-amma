...
export const metadata: Metadata = {
  title: "Pricing — Thanaweya Amma Premium",
  description: "Unlock unlimited Thanaweya Amma practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=thanaweya-amma&cadence=annual`;
